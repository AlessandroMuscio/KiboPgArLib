...
/**
 * The class <code>KnownProblems</code> has the implementation of some of the usual problem that you always forget and need to go watch the solution on StackOverflow even though you know you've already solved them.
 *
