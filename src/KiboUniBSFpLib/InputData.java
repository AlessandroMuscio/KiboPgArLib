...
public class InputData {
  ...
  private final static String RED_ATTENTION = AnsiColors.RED + "Attention!" + AnsiColors.RESET;
  private final static String ALPHANUMERIC_CHARACTERS = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 ";
  private final static String ALPHANUMERIC_CHARACTERS_ERROR = RED_ATTENTION
      + "\nOnly alphanumeric characters are allowed.";
  private final static String EMPTY_STRING_ERROR = RED_ATTENTION + "\nNo characters were inserted.";
  private final static String ALLOWED_CHARACTERS_ERROR = RED_ATTENTION + "\nThe only allowed characters are: %s";
  private final static String INTEGER_FORMAT_ERROR = RED_ATTENTION
      + "\nThe inserted data is in a incorrect format. An integer is required.";
  private final static String DOUBLE_FORMAT_ERROR = RED_ATTENTION
      + "\nThe inserted data is in a incorrect format. A double is required.";
  private final static String MINIMUM_ERROR = RED_ATTENTION + "\nA value greater equal than %.2f is required.";
  private final static String MAXIMUM_ERROR = RED_ATTENTION + "\nA value less equal than %.2f is required.";
  private final static String YES_ANSWERS = "yY";
  private final static String NO_ANSWERS = "nN";
