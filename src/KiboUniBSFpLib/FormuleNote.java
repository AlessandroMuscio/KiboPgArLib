...
/**
 * La classe <strong>FormuleNote</strong> permette di eseguire alcune formule che possono spesso tornare utili.
 *
...
public class FormuleNote {
  ...
  /**
   * Trova l'<strong>MCD</strong> (Massimo Comun Divisore) tra due numeri.
   *
  ...
  /**
   * Trova l'<strong>MCD</strong> (Massimo Comun Divisore) tra diversi numeri.
   *
  ...
  /**
   * Trova l'<strong>MCM</strong> (Minimo Comune Multiplo) tra due numeri.
   *
  ...
  /**
   * Trova l'<strong>MCM</strong> (Minimo Comune Multiplo) tra diversi numeri.
   *
